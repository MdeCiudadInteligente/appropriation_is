...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-05-2015 a las 16:28:20
...
CREATE TABLE IF NOT EXISTS `accompaniments` (
  ...
  KEY `site_id` (`site_id`),
  KEY `user_id` (`user_id`),
  KEY `accompaniment_id` (`accompaniment_type_id`)
...
(389, '2015-04-01', 'Intervención sitio', 'Intervención a sitio público', 'Se sensibilizó a la gente que se encontraba a los alrededores del lugar ', 4, 'IMG_6297.JPG', 'IMG_6298.JPG', '', 'uploads/accompaniment/accompaniment_adjunct', 0, 287, 42, '2015-04-06 07:29:35', '0000-00-00 00:00:00'),
(390, '2015-04-01', 'Intervención sitio', 'Intervención a sitio público', 'Se indagó el uso del internet en el sitio con personas trabajadoras del lugar, igualmente se contó del servio a las personas que se encontraban en el espacio', 5, 'Pista_de_patinaje_Fco_Antonio_Zea_Intervencion_2.JPG', 'Pista_de_patinaje_Fco_Antonio_Zea_Intervencion.JPG', 'Pista_de_patinaje_Fco_Antonio_Zea_Intervencion_3.JPG', 'uploads/accompaniment/accompaniment_adjunct', 0, 478, 42, '2015-04-06 07:32:36', '0000-00-00 00:00:00'),
(391, '2015-04-01', 'Intervención sitio', 'Intervención a sitio público', 'Se vio el flujo de personas del lugar, cuantas sabían del servicio, se notó que muy pocas sabían  que el parque tenía internet gratis.', 4, 'Parque_de_Florencia_Intervencion_1.JPG', 'Parque_de_Florencia_Intervencion.JPG', '', 'uploads/accompaniment/accompaniment_adjunct', 0, 477, 42, '2015-04-06 07:35:35', '0000-00-00 00:00:00'),
...
(408, '2015-04-17', 'Estudiantes de PP, jóvenes por la convivencia o al', 'Capacitación a gestora TIC.', 'Se realizó una reunión con la gestora TIC Alejandra Moreno para planear el inicio del curso de Alfabetización Digital que ella orientará en el Parque Biblioteca Guayabal e iniciamos la capacitación en los contenidos del curso.', 1, 'Parque_Biblioteca_Guayabal_Acompanamiento_a_gestor_TIC.jpg', '', '', 'uploads/accompaniment/accompaniment_adjunct', 0, 192, 43, '2015-04-20 15:50:07', '0000-00-00 00:00:00'),
(409, '2015-05-08', '', 'asdasdasd', 'asdasdasdasdasdasdasdasdasd', 3, '', '', '', '', 5, 141, 12, '2015-05-08 14:29:55', '0000-00-00 00:00:00'),
(410, '2015-05-08', '', 'pruebiririririririjilla', 'esto es una pruebiririririririirjilla', 2, '', '', '', '', 9, 422, 12, '2015-05-08 14:32:50', '0000-00-00 00:00:00');
...
(1, 'practicantes', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:21:29'),
(2, 'Gestores TIC', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:24:39'),
(3, 'Aula Abierta', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:24:44'),
(4, 'Certificación', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:24:48'),
(5, 'Curso, taller', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:25:16'),
(6, 'Intervención sitio', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:25:23'),
(8, 'Laboratorios comunitarios', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:29:12'),
(9, 'Estudiantes del Pascual Bravo', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:29:12'),
(10, 'Otros', 1, 12, '2015-05-07 00:00:00', '2015-05-07 19:29:36');
...
(471, '2015-04-09', 'Seguimiento', 'Reunión de programación de actividades para el año', 'En la reunión se conversó sobre las necesidades de formación que tiene la comunidad aledaña al Telecentro.', 'Se iniciará un taller de herramientas web.20 La idea es empezar el 29 de abril.', NULL, NULL, NULL, '', 0, 520, 21, '2015-04-09 11:36:57', '0000-00-00 00:00:00'),
...
(1, 11, '', 1, 1, 1, '2015-04-29 00:00:00', '2015-05-07 16:16:23', 12),
(2, 12, '', 2, 1, 1, '2015-04-22 00:00:00', '2015-05-07 16:34:15', 12),
...
--
-- Volcado de datos para la tabla `per_participants_population_types`
--

INSERT INTO `per_participants_population_types` (`participant_id`, `population_type_id`) VALUES
(1, 2),
(1, 3),
(1, 7),
(2, 2);
...
(7, 'Martes', '02:10:00', '13:30:00', 1, 12, '2015-05-08 16:17:37', '0000-00-00 00:00:00'),
(8, 'Martes', '16:17:00', '16:17:00', 1, 12, '2015-05-08 16:20:36', '0000-00-00 00:00:00'),
(9, 'Martes', '14:10:00', '13:21:00', 1, 12, '2015-05-08 16:23:22', '0000-00-00 00:00:00'),
(10, 'Martes', '02:13:00', '16:23:00', 1, 12, '2015-05-08 16:24:30', '2015-05-08 14:25:42');
...
ALTER TABLE `accompaniments`
  ADD CONSTRAINT `accompaniments_ibfk_4` FOREIGN KEY (`accompaniment_type_id`) REFERENCES `acc_types` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
ALTER TABLE `meetings`
  ADD CONSTRAINT `meetings_ibfk_3` FOREIGN KEY (`meeting_type_id`) REFERENCES `mee_types` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
ALTER TABLE `per_trainer_schedules`
  ...
  ADD CONSTRAINT `per_trainer_schedules_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`) ON DELETE NO ACTION ON UPDATE CASCADE;
