...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2015 a las 17:38:09
...
CREATE TABLE IF NOT EXISTS `per_participants_population_types` (
  ...
  `popultation_type_id` int(11) NOT NULL,
  KEY `participant_id` (`participant_id`),
  KEY `popultation_type_id` (`popultation_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `per_participants_population_types`
  ...
  ADD CONSTRAINT `per_participants_population_types_ibfk_2` FOREIGN KEY (`popultation_type_id`) REFERENCES `population_types` (`user_id`) ON UPDATE CASCADE;
