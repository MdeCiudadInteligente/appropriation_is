<div class="perPeopleTypes form">
<?php echo $this->Form->create('PerPeopleType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Per People Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PerPeopleType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PerPeopleType.id'))); ?></li>
