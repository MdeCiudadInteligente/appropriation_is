...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Thematic.id')), null, __('Seguro que quieres eliminar # %s?', $this->Form->value('Thematic.id'))); ?></li>
