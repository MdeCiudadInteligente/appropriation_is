...
<?php echo $this->Form->create('TraSessionsThematic'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tra Sessions Thematic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TraSessionsThematic.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TraSessionsThematic.id'))); ?></li>
