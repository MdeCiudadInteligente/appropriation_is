...
<?php echo $this->Form->create('Accompaniment',array('type'=>'file')); ?>
	...
	<?php
		...
		echo $this->Form->input('accompaniment_type',array ('type'=>'select','options' => array ('practicantes'=>'Practicantes','Estudiantes de PP, jóvenes por la convivencia o alfabetizadores'=>'Gestores TIC' ,
				'Aula Abierta'=>'Aula Abierta','Grados'=>'Certificación','Curso, taller o charla'=>'Curso, taller','Intervención sitio'=>'Intervención sitio','Laboratorios comunitarios'=>'Laboratorios comunitarios','Estudiantes del Pascual Bravo'=>'Estudiantes del Pascual Bravo','Kit de inclusion digital
'=>'Kit de inclusión digital
','Otros'=>'Otros'),'empty'=>'Seleccione el tipo de acompañamiento'));
