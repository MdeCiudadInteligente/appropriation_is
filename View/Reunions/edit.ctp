...
<?php echo $this->Form->create('Reunion'); ?>
	<fieldset>
		<legend><?php echo __('Edit Reunion'); ?></legend>
	<?php
		echo $this->Form->input('idreunion');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Reunion.idreunion')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Reunion.idreunion'))); ?></li>
