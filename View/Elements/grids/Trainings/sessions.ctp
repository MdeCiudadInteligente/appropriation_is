	...
	$gridOptions=array(
			...
			'add_operations'=>json_encode(array(
				...
				<div class="custom_render">
					<i class="icon-minus-circle  remove_session  grid-send-service" data-confirm="true" data-type="confirm" data-message="¿Estás seguro de quieres eliminar esta sesión?" data-url="'.$adminUrl.'" data-id="{id}" data-trainingId="{training_id}">
					</i>
