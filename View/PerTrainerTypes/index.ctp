...
<!-- 	End left block -->	
	...
	<div class="right-block">
		...
		<div class="divulgations">
			...
			<?php
				$gridOptions=array(
						'gridId'=>'gridPerTrainerType',
						'gridTitle'=>'Tipo de Formador',
						'height'=>500,
						'serviceUrl'=>'PerTrainerTypes/index_service.json',
						'fields'=>array(
						    array("dataIndex"=>"id","column"=>false),
							array("dataIndex"=>"name_tt",'header'=>'Nombre','sortable'=>true,'align'=>"left","column"=>true),
							array("dataIndex"=>"estado_tt",'header'=>'Estado','sortable'=>true,'align'=>"left","column"=>false),
