<div class="sitetypes-cont app-grid-container">
...
<!-- 	End left block -->	
	...
	<div class="right-block">
		<div class="sitetypes">
			<h2><?php echo __('sitetypes'); ?></h2>
			<?php
				$gridOptions=array(
						'gridId'=>'gridSitetypes',
						'gridTitle'=>'Tipo de sitios',
						'height'=>800,
						'serviceUrl'=>'SiteTypes/index_service.json',
						'fields'=>array(
						    array("dataIndex"=>"id","column"=>false),
			                array("dataIndex"=>"t_sitio",'header'=>'Tipo de sitio','sortable'=>true,'align'=>"left","column"=>true),
			                array("dataIndex"=>"estado_ts",'header'=>'Estado tipo de sitio','sortable'=>true,'align'=>"left","column"=>true),
