	    	...
	    	<legend> Agregar participante</legend>
				<div class="seccion-person">	
					<div class="input" >
						...
						<input type="text"  class="person-autocomplete-trainers" data-required="true" data-valcontainer=".results-input" data-emptymsg="Por favor ingresa minimo una persona">
