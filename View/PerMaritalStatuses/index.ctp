<div class="perMaritalStatuses-cont app-grid-container">
<div class="left-block">
		<div class="actions">
			...
			<ul>
				...
				if ($usuario_level == '1'){?>	
				<li><?php echo $this->Html->link(__('New perMaritalStatuses'), array('action' => 'add')); ?></li>
				<?php }?>
...
<div class="right-block">
		<div class="sites">
			<h2><?php echo __('Permaritalstatuses'); ?></h2>
			<?php
				$gridOptions=array(
						'gridId'=>'gridPermaritalstatuses',
						'gridTitle'=>'Estado Civil',
						'height'=>800,
						'serviceUrl'=>'PerMaritalStatuses/index_service.json',
						'fields'=>array(
